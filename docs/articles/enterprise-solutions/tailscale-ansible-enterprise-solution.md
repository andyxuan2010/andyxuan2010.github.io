---
title: "Enterprise Tailscale + Ansible Multi-Site Management Solution"
summary: "Defines a governed Tailscale and Ansible architecture for secure subnet-routed management of Linux and Windows systems across four Internet-distributed sites."
document_id: "ES-10"
...
> **Document class:** Enterprise architecture solution
> **Applicability:** Secure, subnet-routed Ansible management across four Internet-distributed sites with Linux and Windows targets.
...
## Tailscale control-plane design
...
### Tailscale SSH versus standard SSH
...
## Ansible management architecture
...
The principal cost drivers are the Tailscale subscription tier, Linux subnet-router hosts, optional redundant router and WAN capacity, Ansible controller hosting, backup and monitoring, and engineering time for policy, firewall, and recovery testing. The design should be costed against the required RTO rather than assuming every site needs identical hardware.
...
- [Enterprise Multi-Cloud Ansible Automation Reference Architecture](enterprise-ansible-automation-reference-architecture.md)
- [Hands-On Lab: Tailscale + Ansible Across Four Sites](../hands-on-lab/tailscale-ansible-hands-on-lab.md)
