(() => {
  ...
  const homeHref = new URL("/", window.location.href).href;
  ...
  nav.className = "nav";
  nav.innerHTML = `
    <a class="brand" href="${homeHref}" aria-label="Andy Xuan home">
    ...
    <div class="nav-links" id="site-navigation">
      <a class="nav-item nav-item-home${activeClass("home")}" href="${homeHref}" data-i18n="nav.home">Home</a>
  ...
  if (footer) {
    ...
    const footerHomeHref = isHome ? "#top" : homeHref;
    footer.className = "container";
    footer.innerHTML = `
      <a class="brand" href="${footerHomeHref}">
        <span class="brand-mark">AX</span>
        <span class="brand-copy"><strong>Andy Xuan</strong><small>Cloud Architect</small></span>
      </a>
      <p data-i18n="footer.focus">Cloud · Infrastructure · AI · Automation</p>
      <a class="footer-action" href="${footerHomeHref}" data-i18n="${isHome ? "footer.top" : "footer.home"}">${isHome ? "Back to top ↑" : "Back home ↑"}</a>`;
  }
})();
