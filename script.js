const repositories = [
  { name: "azure-landingzone", description: "Terraform-based Azure Landing Zone for deploying a governed cloud foundation with management groups, shared platform services, hub-spoke networking, private DNS, Key Vault, Log Analytics, Automation, App Service patterns, Linux runner resources, and CI/CD validation through GitHub Actions and Azure DevOps.", category: "Cloud", language: "HCL", tags: ["Terraform", "IaC", "Azure", "Landing Zone", "Azure DevOps"], accent: "#1d4ed8", featured: true, docs: "https://andyxuan2010.github.io/azure-landingzone/" },
  { name: "azure-template", description: "Reusable Azure Terraform template repository for validated IaC modules, root planning harnesses, Azure DevOps pipeline templates, examples, tests, and reference documentation. Designed as a source-of-truth distribution repo for Azure landing zone and workload module consumers.", category: "Cloud", language: "HCL", tags: ["Terraform", "IaC", "Azure", "IaC Modules", "Azure DevOps"], accent: "#0f766e", featured: true, docs: "https://andyxuan2010.github.io/azure-template/" },
  { name: "fortigate-virtual-firewall", description: "Azure FortiGate virtual firewall Terraform deployment with switchable single-node and active-passive HA architectures, existing hub VNet integration, documented routing, RBAC, and operational patterns.", category: "Cloud", language: "HCL", tags: ["Terraform", "IaC", "Azure", "FortiGate", "Networking"], accent: "#c2410c", featured: true },
  { name: "cloud-migration-demo", description: "Small-business migration reference for retiring on-premises Active Directory Domain Services and moving to cloud-native identity, endpoint management, collaboration, and hosted desktop services.", curatedDescription: true, category: "Cloud", language: "Markdown", tags: ["AD DS", "Entra ID", "Intune", "Azure Virtual Desktop", "Google Workspace"], accent: "#be123c", featured: true, docs: "https://andyxuan.ca/cloud-migration-demo/" },
  { name: "OpportunityEquityEngine", description: "Student-centered platform concept that helps high school students discover, understand, and prioritize scholarships, competitions, research programs, volunteering, summer programs, and university-preparation opportunities using verified data, eligibility rules, transparent ranking, and AI-assisted explanations.", curatedDescription: true, category: "Apps", language: "Markdown", tags: ["Education", "Scholarships", "Student Platform", "AI", "Quebec"], accent: "#d97706", featured: true, demo: "https://app-opportunity-dev.azurewebsites.net", docs: "https://andyxuan.ca/OpportunityEquityEngine/" },
  { name: "enterprise-ai-chatbot", description: "Enterprise AI chatbot on Azure using Python, Terraform, Azure App Service, Azure OpenAI, Azure AI Search, Blob Storage, Key Vault, and Entra ID. Implements document-grounded RAG with hybrid search, embeddings, reranking, citation validation, and reusable landing-zone resources.", category: "AI", language: "HCL", tags: ["Python", "IaC", "Azure OpenAI", "RAG", "Azure DevOps"], accent: "#7c3aed", demo: "http://chatbot.andyxuan.ca", featured: true },
  { name: "enterprise-ai-doc", description: "Terraform-based Azure enterprise document extraction workload using Azure AI Document Intelligence, Azure OpenAI, Azure Functions, Logic Apps, and Azure SQL Database to extract, normalize, summarize, and store structured data from invoices, claims, contracts, PDFs, resumes, and forms.", category: "AI", language: "HCL", tags: ["Terraform", "IaC", "Document AI", "Azure Functions", "Azure DevOps"], accent: "#c2410c", demo: "https://func-aidoc-dev.azurewebsites.net/", featured: true },
  ...
  { name: "aws-template", description: "Reusable AWS Terraform template repository for validated infrastructure modules, examples, automation, and delivery pipelines.", category: "Cloud", language: "HCL", tags: ["Terraform", "IaC", "AWS", "IaC Modules", "CI/CD"], accent: "#4d7c0f", featured: true },
  { name: "web-ccoedemo-dotnet", description: "ASP.NET Core .NET 8 Microsoft Entra authentication demo for Azure App Service, showing MSAL and Easy Auth patterns with MVC/Razor views, Azure DevOps ZIP deployment, GitHub Actions deployment, and optional Run From Package pipeline support.", category: "Apps", language: ".NET 8", tags: ["ASP.NET Core", "Entra ID", "App Service", "CI/CD", "Azure DevOps"], accent: "#6d28d9", demo: "http://dotnet.andyxuan.ca", featured: true },
  { name: "web-ccoedemo-python", description: "Python Flask Microsoft Entra authentication demo for Azure App Service, showing MSAL and Easy Auth flows with GitHub Actions and Azure DevOps deployment pipelines.", category: "Apps", language: "Python", tags: ["Flask", "Entra ID", "App Service", "CI/CD", "Azure DevOps"], accent: "#be185d", demo: "http://python.andyxuan.ca", featured: true },
  { name: "ansible-awx-demo", description: "Sanitized Ansible AWX integration demo with cross-platform playbooks, reusable roles, Git-controlled inventory, and safe sample data for learning Ansible CLI and AWX execution patterns.", category: "Automation", language: "YAML", tags: ["Ansible", "AWX", "Automation", "Cross-platform", "Inventory"], accent: "#2563eb", featured: true },
  { name: "AIonK8sDemo", description: "Deploy the large language model “Dolly v2 3B” as an API on a Kubernetes cluster.", category: "AI", language: "HCL", tags: ["Terraform", "IaC", "AKS", "Dolly v2", "Kubernetes"], accent: "#4338ca", featured: true, showInLibrary: false },
  { name: "web-ccoedemo-node", description: "Demonstrates Microsoft Entra authentication in a Node.js and Express application on Azure App Service. Includes application routes, MSAL/Easy Auth patterns, and Azure DevOps deployment pipelines. Intended as an identity and cloud application reference.", category: "Apps", language: "Node.js", tags: ["Express", "Entra ID", "App Service", "CI/CD", "Azure DevOps"], accent: "#15803d", demo: "http://node.andyxuan.ca", featured: true },
  { name: "oci-template", description: "Terraform modules dedicated to the OCI environment.", category: "Cloud", language: "HCL", tags: ["Terraform", "IaC", "OCI", "IaC Modules", "Networking"], accent: "#b91c1c", featured: true },
  { name: "oci-landingzone", description: "Terraform landing zone for provisioning a shared Oracle Cloud Infrastructure foundation, environment-specific configurations, networking, Object Storage, and optional Vault/KMS workloads.", category: "Cloud", language: "HCL", tags: ["Terraform", "IaC", "OCI", "Landing Zone", "Networking"], accent: "#854d0e", featured: true },
