const repositories = [
  ...
  { name: "enterprise-ai-doc", description: "Terraform-based Azure enterprise document extraction workload using Azure AI Document Intelligence, Azure OpenAI, Azure Functions, Logic Apps, and Azure SQL Database to extract, normalize, summarize, and store structured data from invoices, claims, contracts, PDFs, resumes, and forms.", category: "AI", language: "HCL", tags: ["Terraform", "IaC", "Document AI", "Azure Functions", "Azure DevOps"], accent: "#c2410c", featured: true },
